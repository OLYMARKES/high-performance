...
RAW_PARTICIPANTS = [
    ...
    {"name": "Алена Замесина", "public_name": "Алена", "contact": "Alenazamesina", "issue": 56, "token": "n7v3k8p2m5q4", "paid": False},
    {"name": "Севара", "public_name": "Севара", "contact": "@sevaragreene", "issue": 38, "token": "r4m8t2q6v1k9", "paid": False},
