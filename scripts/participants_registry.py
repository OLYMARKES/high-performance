...
RAW_PARTICIPANTS = [
    ...
    {"name": "Яна Федорова", "public_name": "Яна", "contact": "@yanabraun", "source": "manual", "token": "h8m3q5z7k2w9"},
    {
        "name": "Лера",
        "public_name": "Лера",
        "contact": "@lerakurepina",
        "issue": 26,
        "token": "d6v9n3k7t2m8",
        "questionnaire_token": "j4m9v2k6t8q3",
    },
    ...
    {"name": "Вера", "public_name": "Вера", "contact": "@verushkavera", "issue": 22, "token": "u5n2c8r4x7p1"},
    {
        ...
        "issue": 21,
        "token": "j4m9v2k6t8q3",
        "questionnaire_token": "d6v9n3k7t2m8",
    },
    ...
    {"name": "Алена Замесина", "public_name": "Алена", "contact": "@alenazamesina", "issue": 56, "token": "n7v3k8p2m5q4", "paid": True, "active": True},
